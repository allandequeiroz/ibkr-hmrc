# Trial Balance Validation Prompt

For use with another AI that has access to the project files and internet.
...
- `16235546_trial_balance.html` -- generated trial balance (period ending 28 February 2026)
